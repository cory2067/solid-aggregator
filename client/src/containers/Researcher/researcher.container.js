...
const researchers = [
  {
    ...
    description: 'we are researching the average age of researchers',
    query: 'average foaf:age',
  },
  {
    id: 1,
    name: 'some other research group',
    description: 'we are researching the sum age of researchers',
    query: 'sum foaf:age'
  }
];
...
class ResearcherComponent extends Component<Props> {
  ...
  render() {
    ...
    return (
      <ResearcherPageContent name={name} isLoading={isLoading} researchers={researchers}
